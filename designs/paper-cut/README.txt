Paper Cut - Pi Clock design package
...
Install from the SD card
  Copy this folder to piclock-designs/paper-cut/ on the boot partition.

Install over the network
  scp -r paper-cut terry@192.168.1.217:/home/terry/piclock-designs/
