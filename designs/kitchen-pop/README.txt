Kitchen Pop - Pi Clock design package
Made with Pi Clock Design Creator

Contents
  loop.mp4      480x480 H.264 animation, 6s at 15 fps (90 frames)
...
Install from the SD card
  Copy this folder to piclock-designs/kitchen-pop/ on the boot partition.

Install over the network
  scp -r kitchen-pop terry@192.168.1.217:/home/terry/piclock-designs/
